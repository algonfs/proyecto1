...
<html lang="en">
    ...
    <!-- Site CSS -->
    <link rel="stylesheet" href="{{asset('principal/style.css')}}">
    <!-- Colors CSS -->
    <link rel="stylesheet" href="{{asset('principal/css/colors.css')}}">
    <!-- ALL VERSION CSS -->
    <link rel="stylesheet" href="{{asset('principal/css/versions.css')}}">
    <!-- Responsive CSS -->
    ...
    <script src="{{asset('principal/js/modernizer.js')}}"></script>
...
<body class="host_version" id="aqui"> 
        ...
        <nav class="megamenu navbar navbar-default" >
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><img src="{{asset('principal/images/logos/logobolivar.png')}}" alt="image" width="200px" height="50"></a>
                </div>
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li><a data-scroll class="active" href="#aqui">inicio</a></li>
                        <li><a data-scroll href="#quienes">quienes somos </a></li>
                        <li><a data-scroll href="#ser">Servicio</a></li>
                        {{-- <li><a data-scroll href="#pricing">>Precios</a></li> --}}
                        <li><a data-scroll href="#testimonios">Testimonios</a></li>
                        <li><a data-scroll href="#servicio">Contactos</a></li>
                        ...
                        @else
                        <li> <a href="{{ route('login') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Iniciar Sesion</a></li>

                            @if (Route::has('register'))
                            <li>       <a href="{{ route('register') }}" class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">Registrose</a></li>
                            @endif
                        @endauth
                @endif
                    </ul>
	...
	<div id="bootstrap-touch-slider" class="carousel bs-slider fade  control-round indicators-line" data-ride="carousel" data-pause="hover" data-interval="false" >
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				<div id="home" class="first-section" style="background-image:url('principal/uploads/segundo.png');" > 
					<div class="container">
						<div class="row">
							<div class="col-md-12 col-sm-12 text-center">
								<div class="big-tagline">
									<!-- <img src="{{asset('principal/images/logos/logobolivar.png')}}" alt="image" width="200px"> -->
									<h2 data-animation="animated zoomInRight">Inicia Tu <strong>Viaje Con</strong> Nosotros</h2>
									<p class="lead" data-animation="animated fadeInLeft">Facilida y confianza en un solo lugar </p>
									 <a data-scroll href="#pricing" class="btn btn-light btn-radius btn-brd effect-1 slide-btn" data-animation="animated fadeInLeft">Precios</a>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<div id="home" class="first-section" style="background-image:url('principal/uploads/segundo.png');">
					<div class="container">
						<div class="row">
							<div class="col-md-12 col-sm-12 text-center">
								<div class="big-tagline">
									<!-- <img src="{{asset('principal/images/logos/logo-hosting.png')}}" alt="image"> -->
									<h2 data-animation="animated zoomInRight">La Mejor <strong>Empresa</strong></h2>
									<p class="lead" data-animation="animated fadeInLeft">Facilida y confianza en un solo lugar</p>
									 <a data-scroll href="#pricing" class="btn btn-light btn-radius btn-brd effect-1 slide-btn" data-animation="animated fadeInLeft">Precios</a>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<!-- <a data-scroll href="#overviews" class="btn btn-light btn-radius btn-brd effect-1 slide-btn" data-animation="animated fadeInRight">All Features</a> -->
					...
					<div class="container">
						<div class="row">
							<div class="col-md-12 col-sm-12 text-center">
								<div class="big-tagline">
									<!-- <img src="{{asset('principal/images/logos/logo-hosting.png')}}" alt="image"> -->
									<h2 data-animation="animated zoomInRight">Compras <strong>Y Resevas </strong> Online</h2>
									<p class="lead" data-animation="animated fadeInLeft"> Ahorra tiempo desde tu comodidad</p>
									 <a data-scroll href="#pricing" class="btn btn-light btn-radius btn-brd effect-1 slide-btn" data-animation="animated fadeInLeft">Precios</a>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<!-- <a data-scroll href="#overviews" class="btn btn-light btn-radius btn-brd effect-1 slide-btn" data-animation="animated fadeInRight">All Features</a> -->
								</div>
    ...
    <div id="quienes" class="section wb" >
        <div class="container">
            <div class="section-title row text-center">
                ...
                <h3 data-animation="animated zoomInRight"><strong>Quienes Somos</strong></h3>
            ...
            <div class="row">
				...
				<div class="col-md-6">
                    <div class="post-media wow fadeIn">
                        <img src="{{asset('principal/uploads/flota.jpg')}}" width="100px" alt="" class="img-responsive img-rounded">
                        <a href="https://www.youtube.com/watch?v=zvDGe9eKXgk"  data-rel="prettyPhoto[gal]" class="playbutton"><i class="flaticon-play-button"></i></a>
                    </div><!-- end media -->
                </div><!-- end col -->
            </div><!-- end row -->
...
{{-- 
    ...
    <div id="ser" class="section wb" style="background: rgb(248, 248, 248)">
        <div class="container">
            <div class="section-title text-center">
                <h3>Noestros Servicios</h3>
            ...
            <div class="row dev-list text-center">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                    <div class="widget clearfix">
                        <img src="{{asset('principal/uploads/normal.jpg')}}" alt=""  class="img-responsive">
                        ...
                        <a href="#pricing" data-scroll class="btn btn-light grd1 effect-1 btn-radius btn-brd">Adquirir</a>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s">
                    <div class="widget clearfix">
                        <img src="{{asset('principal/uploads/semi.jpg')}}" alt="" class="img-responsive">
                        <div class="widget-title">
                            <h3>Semi-Cama</h3>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.6s">
                    <div class="widget clearfix">
                        <img src="{{asset('principal/uploads/suit.jpg')}}" alt="" class="img-responsive">
                        <div class="widget-title">
                            <h3>Suit Class</h3>
...
{{-- 
    ...
    <div id="testimonios" class="parallax section db parallax-off" style="background-image:url('principal/uploads/parallax_04.jpg');">
        <div class="container">
            <div class="section-title text-center">
                <h3>Testimonios</h3>
                    ...
                    <div class="testi-carousel owl-carousel owl-theme">
                        <div class="testimonial clearfix">
                            ...
                            <div class="testi-meta">
                                <img src="{{asset('principal/uploads/testi_01.png')}}" alt="" class="img-responsive alignleft">
                        ...
                        <div class="testimonial clearfix">
                            ...
                            <div class="testi-meta">
                                <img src="{{asset('principal/uploads/testi_02.png')}}" alt="" class="img-responsive alignleft">
                        ...
                        <div class="testimonial clearfix">
                            ...
                            <div class="testi-meta">
                                <img src="{{asset('principal/uploads/testi_03.png')}}" alt="" class="img-responsive alignleft">
    ...
    <div id="servicio" class="section wb">
        <div class="container">
            <div class="section-title text-center">
                <h3>¿Necesitas ayuda? ¡Seguro que estamos en línea!</h3>
                <p class="lead">Permítanos brindarle más detalles sobre el sitio web de la oferta especial que desea. Por favor, rellene el siguiente formulario <br>
        ¡Tenemos mucho  clientes felices de viajar con nosotros!</p>
            </div><!-- end title -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="widget clearfix">
                        <div class="widget-title">
                            <img src="{{asset('principal/images/logos/logo-hosting-light.png')}}" alt="">
    ...
    <!-- ALL JS FILES -->
    <script src="{{asset('principal/js/all.js')}}"></script>
    <!-- ALL PLUGINS -->
